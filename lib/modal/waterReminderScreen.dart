...
import 'package:reminder_app/constants/firebase_constants.dart';
...
class _WaterReminderState extends State<WaterReminder> {
          ...
          GestureDetector(
            ...
            child: Row(
              children: [
                Text(
                  "Add",
                  style: body2TextStyle.copyWith(fontSize: 20),
                ),
                Icon(Icons.add)
              ],
            ),
  ...
  _bodyListContainer(int length, AsyncSnapshot snapshot) {
